...
namespace madrona_gpudrive
{
    ...
    NB_MODULE(madrona_gpudrive, m)
    {
        ...
        nb::class_<Parameters>(m, "Parameters")
            ...
            .def_rw("allowStaticAgentControl", &Parameters::allowStaticAgentControl)
            .def_rw("allowExpertAgentControl", &Parameters::allowExpertAgentControl)
            .def_rw("mirrorX", &Parameters::mirrorX);

...
namespace madrona_gpudrive
{
    ...
    struct Parameters
    {
        ...
        bool allowStaticAgentControl = false;      // Allow static agents to be controlled
        bool allowExpertAgentControl = false;      // Allow expert-marked agents to be controlled
        bool mirrorX = false;                      // Mirror X coordinates & adjust headings (π - θ)
    };
